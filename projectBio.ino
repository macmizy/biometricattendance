...
const char *ssid = "RM";  //ENTER YOUR WIFI SETTINGS
const char *password = "trabosky";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.0.146/biometricattendance/getdata.php"; //computer IP or the server domain
...
// Function declaration for connectToWiFi
void connectToWiFi();
// Function declaration for ChecktoAddID
void ChecktoAddID();
void setup() {
...
int getFingerprintID() {
  ...
  // Serial.print("Image capture result: ");
  // Serial.println(p);
  switch (p) {
    case FINGERPRINT_OK:
...
uint8_t deleteFingerprint( int id) {
  ...
  if (p == FINGERPRINT_OK) {
    ...
    display.display();
    return 0; // Add a default return value at the end of the function
...
uint8_t getFingerprintEnroll() {
  ...
  if (p == FINGERPRINT_OK) {
    ...
    display.display();
    confirmAdding();
    return 0; // Replace DEFAULT_VALUE with an appropriate value
  } else if (p == FINGERPRINT_PACKETRECIEVEERR) {
    Serial.println("Communication error");
    return p;
  } else if (p == FINGERPRINT_BADLOCATION) {
